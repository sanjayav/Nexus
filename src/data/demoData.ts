// Demo Co Sample Data for Nexus PoC Demo
// All numbers are realistic for ~21.5M tCO2e total, ~12M tons product output
...
export const blockchainRecords: BlockchainRecord[] = [
  {
    ...
    eventType: 'Submitted',
    facility: 'Olefins Plant Beta',
    dataPoint: 'Scope 1 Emissions - Q1 2026',
    submitter: 'Alex Rivera',
    submitterDID: 'did:nexus:demo:0x7a3b...4f2e',
    approver: '',
    approverDID: '',
  ...
  },
  {
    ...
    submitter: 'Alex Rivera',
    submitterDID: 'did:nexus:demo:0x7a3b...4f2e',
    approver: 'Dr. Jordan Lee',
    approverDID: 'did:nexus:demo:0x2c8d...9a1f',
  ...
  },
  {
    ...
    eventType: 'Submitted',
    facility: 'Refinery Alpha',
    dataPoint: 'Scope 1 Emissions - Q1 2026',
    submitter: 'Priya Patel',
    submitterDID: 'did:nexus:demo:0x5d2e...8b3c',
    approver: '',
    approverDID: '',
  ...
  },
  {
    ...
    eventType: 'Approved',
    facility: 'Polymers Plant Delta',
    dataPoint: 'Energy Consumption - Q4 2025',
    submitter: 'Nathan Carter',
    submitterDID: 'did:nexus:demo:0x1f4a...6e9d',
    approver: 'Dr. Jordan Lee',
    approverDID: 'did:nexus:demo:0x2c8d...9a1f',
  ...
  },
  {
    ...
    facility: 'Demo Co (All)',
    dataPoint: 'CDP Climate Change 2026 Response',
    submitter: 'System',
    submitterDID: 'did:nexus:system:report',
    approver: 'William Carter',
    approverDID: 'did:nexus:demo:0x8e3f...2d4a',
  ...
  },
  {
    ...
    eventType: 'Submitted',
    facility: 'Green Chem Plant Zeta',
    dataPoint: 'Waste Generation - Q1 2026',
    submitter: 'Kevin Brown',
    submitterDID: 'did:nexus:demo:0x3a7c...1e5f',
    approver: '',
    approverDID: '',
  ...
  },
  {
    ...
    eventType: 'Approved',
    facility: 'Aromatics Complex Gamma',
    dataPoint: 'Scope 1 Emissions - Q4 2025',
    submitter: 'Tara North',
    submitterDID: 'did:nexus:demo:0x6b2d...3c8e',
    approver: 'Dr. Jordan Lee',
    approverDID: 'did:nexus:demo:0x2c8d...9a1f',
  ...
  },
  {
    ...
    eventType: 'Submitted',
    facility: 'Bioplastics R&D Center',
    dataPoint: 'Recycled Content Volume - Q1 2026',
    submitter: 'Amy Jensen',
    submitterDID: 'did:nexus:demo:0x9f1a...7d2e',
    approver: '',
    approverDID: '',
  ...
  },
  {
    ...
    eventType: 'Approved',
    facility: 'Bioplastics R&D Center 2',
    dataPoint: 'Bioplastic Production - Q4 2025',
    submitter: 'Charlie King',
    submitterDID: 'did:nexus:demo:0x4e8b...2a6f',
    approver: 'William Carter',
    approverDID: 'did:nexus:demo:0x8e3f...2d4a',
  ...
  },
  {
    ...
    eventType: 'Submitted',
    facility: 'Polymers Plant Delta-2',
    dataPoint: 'Scope 1 Emissions - Q1 2026',
    submitter: 'Rachel Park',
    submitterDID: 'did:nexus:demo:0x2b5e...8c1d',
    approver: '',
    approverDID: '',
...
export const suppliers: Supplier[] = [
  { id: 'sup-01', name: 'Acme Cement', category: 'Raw Materials', estimatedEmissions: 1250000, dataCompleteness: 92, tier: 1, country: 'GB', status: 'complete', dataFormat: 'supplier-provided', lastUpdated: '2026-03-15' },
  { id: 'sup-02', name: 'Beta Petrochem', category: 'Petrochemical Feedstock', estimatedEmissions: 980000, dataCompleteness: 88, tier: 1, country: 'GB', status: 'complete', dataFormat: 'supplier-provided', lastUpdated: '2026-03-12' },
  { id: 'sup-03', name: 'Gamma Refining', category: 'Refined Products', estimatedEmissions: 870000, dataCompleteness: 95, tier: 1, country: 'GB', status: 'complete', dataFormat: 'supplier-provided', lastUpdated: '2026-03-20' },
  { id: 'sup-04', name: 'Delta Energy', category: 'Natural Gas Supply', estimatedEmissions: 1540000, dataCompleteness: 91, tier: 1, country: 'GB', status: 'complete', dataFormat: 'supplier-provided', lastUpdated: '2026-03-18' },
  { id: 'sup-05', name: 'Epsilon Resins', category: 'PET Feedstock', estimatedEmissions: 720000, dataCompleteness: 78, tier: 1, country: 'GB', status: 'partial', dataFormat: 'supplier-provided', lastUpdated: '2026-02-28' },
  { id: 'sup-06', name: 'Zeta Fuels', category: 'Fuel Supply', estimatedEmissions: 560000, dataCompleteness: 82, tier: 1, country: 'GB', status: 'complete', dataFormat: 'supplier-provided', lastUpdated: '2026-03-10' },
  { id: 'sup-07', name: 'Eta Petroleum', category: 'Petroleum Products', estimatedEmissions: 430000, dataCompleteness: 45, tier: 1, country: 'GB', status: 'incomplete', dataFormat: 'estimated', lastUpdated: '2025-12-15' },
  { id: 'sup-08', name: 'Theta Power', category: 'Electricity & Utilities', estimatedEmissions: 680000, dataCompleteness: 72, tier: 1, country: 'GB', status: 'partial', dataFormat: 'supplier-provided', lastUpdated: '2026-02-20' },
  { id: 'sup-09', name: 'Iota Chemicals', category: 'Chemical Intermediates', estimatedEmissions: 310000, dataCompleteness: 38, tier: 1, country: 'GB', status: 'incomplete', dataFormat: 'estimated', lastUpdated: '2025-11-30' },
  { id: 'sup-10', name: 'Kappa Specialties', category: 'Specialty Chemicals', estimatedEmissions: 290000, dataCompleteness: 35, tier: 1, country: 'GB', status: 'incomplete', dataFormat: 'estimated', lastUpdated: '2025-10-15' },
];
...
export const anomalies: AnomalyRecord[] = [
  ...
  },
  {
    ...
    recommendation: 'Q1 typically runs higher due to turnaround activities, but 12% exceeds the normal seasonal band (±5%). Check if the Refinery Alpha had a prolonged flaring event or process upset in Jan–Mar 2026. If operational, model whether Q2–Q4 improvement can compensate. If structural (e.g., heavier crude slate), update the SBTi trajectory forecast and flag to the sustainability committee.',
  },
  {
    id: 'anom-004',
    severity: 'warning',
    ...
    actualValue: '20% gap',
    recommendation: 'While technically compliant under GHG Protocol Scope 2 Guidance, CDP and ISSB/IFRS S2 increasingly scrutinize REC quality. Verify that I-RECs meet temporal matching (same calendar year), geographic matching (national grid), and additionality criteria. Consider transitioning from unbundled RECs to PPAs for future reporting credibility. Document the REC procurement strategy in the CDP response Section C8.',
  },
  {
    id: 'anom-005',
    severity: 'critical',
    title: 'Fugitive Emissions 3× Standard Deviation in Feb 2026',
    description: 'Fugitive emissions at Olefins Plant Beta spiked to 52,000 tCO₂e in February 2026 — more than 3× the standard deviation from the 12-month rolling mean (18,200 ± 11,000 tCO₂e). This single data point accounts for an anomalous 8% of the facility\'s monthly Scope 1.',
...
export const yoyComparison = {
  scope1: {
    ...
    note: 'Q1 intensity spike at Refinery Alpha driving annualized projection above 2025',
  },
  scope2: {
...
export const workflowItems: WorkflowItem[] = [
  { id: 'wf-001', facility: 'Olefins Plant Beta', dataType: 'Scope 1 Process Emissions — Q1 2026', submittedBy: 'Alex Rivera', submittedDate: '2026-04-07', status: 'pending', value: '742,000 tCO\u2082e', scope: 'Scope 1', assignedTo: 'Dr. Jordan Lee', assignedRole: 'team-lead', entityType: 'intercompany' },
  { id: 'wf-002', facility: 'Refinery Alpha', dataType: 'Scope 1 Combustion — Q1 2026', submittedBy: 'Priya Patel', submittedDate: '2026-04-06', status: 'pending', value: '398,000 tCO\u2082e', scope: 'Scope 1', assignedTo: 'Alex Rivera', assignedRole: 'facility-manager', entityType: 'intercompany' },
  { id: 'wf-003', facility: 'Green Chem Plant Zeta', dataType: 'Waste Generation Data — Q1 2026', submittedBy: 'Kevin Brown', submittedDate: '2026-04-05', status: 'pending', value: '612 tonnes', scope: 'Waste', assignedTo: 'Kevin Brown', assignedRole: 'site-owner', entityType: 'subsidiary' },
  { id: 'wf-004', facility: 'Bioplastics R&D Center', dataType: 'Recycled Content Volume — Q1 2026', submittedBy: 'Amy Jensen', submittedDate: '2026-04-04', status: 'pending', value: '11,250 tonnes', scope: 'Circular', assignedTo: 'Amy Jensen', assignedRole: 'facility-manager', entityType: 'subsidiary' },
  { id: 'wf-005', facility: 'Polymers Plant Delta', dataType: 'Scope 1 Emissions — Q1 2026', submittedBy: 'Nathan Carter', submittedDate: '2026-04-03', status: 'approved', value: '225,000 tCO\u2082e', scope: 'Scope 1', assignedTo: 'Dr. Jordan Lee', assignedRole: 'team-lead', entityType: 'subsidiary' },
  { id: 'wf-006', facility: 'Polymers Plant Delta-2', dataType: 'Scope 1 Emissions — Q1 2026', submittedBy: 'Rachel Park', submittedDate: '2026-04-03', status: 'approved', value: '32,000 tCO\u2082e', scope: 'Scope 1', assignedTo: 'Alex Rivera', assignedRole: 'facility-manager', entityType: 'subsidiary' },
  { id: 'wf-007', facility: 'Aromatics Complex Gamma', dataType: 'Energy Consumption — Q1 2026', submittedBy: 'Tara North', submittedDate: '2026-04-02', status: 'anchored', value: '1,130 GWh', scope: 'Energy', assignedTo: 'System', assignedRole: 'auto', entityType: 'intercompany' },
  { id: 'wf-008', facility: 'Bioplastics R&D Center 2', dataType: 'PLA Production Volume — Q1 2026', submittedBy: 'Charlie King', submittedDate: '2026-04-01', status: 'anchored', value: '9,375 tonnes', scope: 'Production', assignedTo: 'Amy Jensen', assignedRole: 'facility-manager', entityType: 'subsidiary' },
];
...
export const circularMetrics: CircularMetric[] = [
  { id: 'cm-01', facility: 'Bioplastics R&D Center', metric: 'Recycled PET Volume', value: 45000, unit: 'tonnes/year', target: 50000, yoyChange: 12.5 },
  { id: 'cm-02', facility: 'Bioplastics R&D Center', metric: 'Recycled Content Rate', value: 78, unit: '%', target: 85, yoyChange: 5.2 },
  { id: 'cm-03', facility: 'Bioplastics R&D Center', metric: 'Waste Diversion', value: 92, unit: '%', target: 95, yoyChange: 3.1 },
  { id: 'cm-04', facility: 'Bioplastics R&D Center 2', metric: 'PLA Production Volume', value: 150000, unit: 'tonnes/year', target: 175000, yoyChange: 8.7 },
  { id: 'cm-05', facility: 'Bioplastics R&D Center 2', metric: 'Bio-based Content', value: 100, unit: '%', target: 100, yoyChange: 0 },
  { id: 'cm-06', facility: 'Bioplastics R&D Center 2', metric: 'Carbon Footprint Reduction vs Conventional', value: 60, unit: '%', target: 65, yoyChange: 4.3 },
  { id: 'cm-07', facility: 'Demo Co (All)', metric: 'Overall Waste Diversion Rate', value: 87, unit: '%', target: 92, yoyChange: 2.8 },
  { id: 'cm-08', facility: 'Demo Co (All)', metric: 'Recycled Material Input', value: 340000, unit: 'tonnes/year', target: 400000, yoyChange: 15.2 },
  { id: 'cm-09', facility: 'Demo Co (All)', metric: 'Hazardous Waste Recycled', value: 72, unit: '%', target: 80, yoyChange: 6.1 },
];
...
export const aiReportText = `## Demo Co Q1 2026 Emissions Performance Summary

Demo Co's Q1 2026 greenhouse gas emissions total **5.58 million tCO\u2082e**, representing the first quarter of the FY 2026 reporting cycle. Annualized, this projects to approximately **22.3 million tCO\u2082e** — a **5.7% increase** over FY 2025 (21.1M) if sustained. However, Q1 typically trends higher due to seasonal factors and turnaround activities.

### Key Highlights

**Scope 1 emissions** for Q1 are **2.12 million tCO\u2082e**, tracking slightly above the FY 2025 quarterly run-rate. The anomaly detection engine has flagged elevated Scope 1 intensity at Refinery Alpha (0.47 tCO\u2082e/tonne vs 0.42 trailing average), likely driven by a prolonged turnaround in January.
...
- **Fugitive emissions spike** at Olefins Plant Beta in February (52,000 tCO\u2082e, 3\u00d7 standard deviation) — under investigation
- **Scope 1 intensity** at Refinery Alpha **12% above** 5-year trend — monitoring through Q2
- **Scope 2 market/location gap** widening to 20% — REC quality review recommended before CDP submission

### SBTi Target Alignment

The 2026 SBTi target is **15.28 million tCO\u2082e**. At the current Q1 annualized rate, the group is projected **46% above target**. Structural reduction levers including carbon capture at Olefins Plant Beta and expanded PPA procurement are critical.
...
export const scope2Sources = [
  { id: 'electricity', label: 'Purchased Electricity', unit: 'tCO\u2082e', description: 'Grid electricity consumption across all facilities. EF: national grid 0.4999 tCO\u2082e/MWh' },
