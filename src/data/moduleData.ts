...
export const frameworkQuestions: FrameworkQuestion[] = [
  // CDP Questions
  { id: 'fq-cdp-01', frameworkId: 'cdp', sectionId: 'C0', sectionName: 'Introduction', questionNumber: 'C0.1', questionText: 'Give a general description and introduction to your organization.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'approved', response: 'Demo Co is Thailand\'s largest integrated petrochemical company...' },
  ...
  { id: 'fq-cdp-03', frameworkId: 'cdp', sectionId: 'C1', sectionName: 'Governance', questionNumber: 'C1.1', questionText: 'Is there board-level oversight of climate-related issues within your organization?', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'approved', response: 'Yes. The Sustainability & Risk Management Committee...' },
  { id: 'fq-cdp-04', frameworkId: 'cdp', sectionId: 'C1', sectionName: 'Governance', questionNumber: 'C1.2', questionText: 'Provide the highest management-level position(s) or committee(s) with responsibility for climate-related issues.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'approved', response: 'Chief Sustainability Officer, reporting directly to CEO...' },
  ...
  // TCFD Questions
  { id: 'fq-tcfd-01', frameworkId: 'tcfd', sectionId: 'governance', sectionName: 'Governance', questionNumber: 'GOV-1', questionText: 'Describe the board\'s oversight of climate-related risks and opportunities.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'approved', response: 'The Board\'s Sustainability Committee meets quarterly to review climate risks...' },
  { id: 'fq-tcfd-02', frameworkId: 'tcfd', sectionId: 'governance', sectionName: 'Governance', questionNumber: 'GOV-2', questionText: 'Describe management\'s role in assessing and managing climate-related risks and opportunities.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'approved', response: 'The CSO chairs a cross-functional Climate Action Working Group...' },
  { id: 'fq-tcfd-03', frameworkId: 'tcfd', sectionId: 'strategy', sectionName: 'Strategy', questionNumber: 'STR-1', questionText: 'Describe the climate-related risks and opportunities the organization has identified over the short, medium, and long term.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'in-review', response: 'Short-term: carbon pricing risk, regulatory compliance costs...' },
  { id: 'fq-tcfd-04', frameworkId: 'tcfd', sectionId: 'strategy', sectionName: 'Strategy', questionNumber: 'STR-3', questionText: 'Describe the resilience of the organization\'s strategy, taking into consideration different climate-related scenarios.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'draft', response: '' },
  ...
  { id: 'fq-csrd-01', frameworkId: 'csrd', sectionId: 'E1-1', sectionName: 'ESRS E1: Climate Change', questionNumber: 'E1.1', questionText: 'Describe the transition plan for climate change mitigation, including targets and actions.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'draft', response: '' },
  { id: 'fq-csrd-02', frameworkId: 'csrd', sectionId: 'E1-4', sectionName: 'ESRS E1: Climate Change', questionNumber: 'E1.4', questionText: 'Disclose the targets related to climate change mitigation and adaptation.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'draft', response: '' },
  ...
  { id: 'fq-csrd-05', frameworkId: 'csrd', sectionId: 'E1-9', sectionName: 'ESRS E1: Climate Change', questionNumber: 'E1.9', questionText: 'Disclose the anticipated financial effects from material physical and transition risks.', assignedRole: 'team-lead', assignedTo: 'Dr. Jordan Lee', status: 'draft', response: '' },
]
