// Demo Co FY2022–FY2025 Historical Values
// Source: Demo Co — Sustainability Performance Data (pub. Feb 2026)
// Scope: Demo Co + 11 subsidiaries, per the report's Reporting Scope (GRI 2-2).
// JV parallel scope (Logistics JV, Biochem JV, Polymers JV) is tracked separately.
...
export interface HistoricalValue {
  ...
  sourceReport: string       // "Demo Co FY2025 SPD — p.<n>"
  footnoteRefs?: string[]
}

// ═══════════════════════════════════════════
// Demo Co in Reporting Scope (GRI 2-2)
// ═══════════════════════════════════════════

export const DEMO_GROUP_COMPANIES = [
  { name: 'Demo Co Public Limited', years: [2023, 2024, 2025] },
  { name: 'Solutions Sub A Ltd', years: [2023, 2024, 2025] },
  { name: 'Maintenance Sub B Ltd', years: [2023, 2024, 2025] },
  { name: 'Safety Sub C Ltd', years: [2023, 2024, 2025] },
  { name: 'Treasury Sub D Ltd', years: [2023, 2024, 2025] },
  { name: 'Estate Sub E Ltd', years: [2023, 2024, 2025] },
  { name: 'Marketing Sub F Ltd', years: [2023, 2024, 2025] },
  { name: 'Logistics JV Ltd', years: [2023, 2024, 2025], note: 'Renamed from Logistics Sub on 2024-09-05' },
  { name: 'Polyols Sub G Ltd', years: [2023, 2024, 2025] },
  { name: 'Green Chemicals Sub H Ltd', years: [2023, 2024, 2025] },
  { name: 'Biochem JV Ltd', years: [2023, 2024, 2025] },
  { name: 'Asahi JV Ltd', years: [2023, 2024], note: 'Operations ceased — JV, 50% shareholding' },
  { name: 'Polymers JV Ltd', years: [2023, 2024, 2025], note: '41.44% shareholding — largest shareholder' },
  { name: 'PTA Sub I Ltd', years: [2023, 2024, 2025] },
  { name: 'PET Resin Sub J Ltd', years: [2023, 2024, 2025] },
  { name: 'Bioplastics R&D Sub Ltd', years: [2023, 2024, 2025] },
] as const

// ═══════════════════════════════════════════
// Historical values — Demo Co
// ═══════════════════════════════════════════

export const DEMO_HISTORICAL_VALUES: HistoricalValue[] = [
  // ─── Financial Capital (GRI 201-1) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.7',
  },
  {
    griCode: '201-1 (2016)', section: 'Financial Capital', subsection: 'Direct Economic Value Generated',
  ...
  },
  {
    ...
    lineItem: 'Proportion of spending on local suppliers', unit: '%', scopeKey: null, reportingScope: 'group',
  ...
  // ─── Manufacture Capital (GRI 2-5) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.8',
  },
  {
    griCode: '2-5 (2021)', section: 'Manufacture Capital', subsection: 'Return on Environmental Investment',
  ...
  // ─── Human Capital — Workforce totals (GRI 2-7, 2-8) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.9',
  },
  {
    griCode: '2-7 (2021)', section: 'Human Capital', subsection: 'Workforce',
  ...
  },
  {
    ...
    lineItem: 'Total Employee — Region A', unit: 'Persons', scopeKey: 'male', reportingScope: 'group',
    values: { 2022: 4309, 2023: 4294, 2024: 5464, 2025: 4033 },
    sourceReport: 'Demo Co FY2025 SPD — p.9',
  },
  {
    griCode: '2-7 (2021)', section: 'Human Capital', subsection: 'Workforce by Area',
    lineItem: 'Total Employee — Region A', unit: 'Persons', scopeKey: 'female', reportingScope: 'group',
  ...
  // ─── Human Capital — Hires (GRI 401-1) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.11',
  },
  {
    griCode: '401-1 (2016)', section: 'Human Capital', subsection: 'New Employees',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.12',
  },
  {
    griCode: '401-1 (2016)', section: 'Human Capital', subsection: 'Turnover',
  ...
  // ─── Human Capital — Training (GRI 404-1) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.13',
  },
  {
    griCode: '404-1 (2016)', section: 'Human Capital', subsection: 'Training and Development',
  ...
  // ─── Human Capital — Gender diversity (GRI 405-1) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.15',
  },
  {
    griCode: '405-1 (2016)', section: 'Human Capital', subsection: 'Gender Diversity',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.16',
  },
  ...
  // ─── Health & Safety (GRI 403-9) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.17',
  },
  {
    griCode: '403-9 (2018)', section: 'Human Capital', subsection: 'Health & Safety',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.19',
  },
  {
    griCode: '403-9 (2018)', section: 'Human Capital', subsection: 'Health & Safety',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.20',
  },
  {
    ...
    targetFy2026: 0,
    sourceReport: 'Demo Co FY2025 SPD — p.21',
  },
  {
    griCode: 'G4-OG13', section: 'Human Capital', subsection: 'Process Safety',
  ...
  // ─── Social & Relationship Capital — Governance ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.16, p.23',
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.23',
  },
  {
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.24',
  },
  ...
  // ─── Compliance (GRI 205, 206, 406, 2-27) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.25',
  },
  {
  ...
  // ─── Supply Chain (GRI 308, 414, 2-6) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.29',
  },
  {
  ...
  },
  {
    ...
    targetFy2026: 86,
    sourceReport: 'Demo Co FY2025 SPD — p.30',
  },
  ...
  // ─── Natural Capital — Materials (GRI 301-1) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.31',
  },
  {
    griCode: '301-1 (2016)', section: 'Natural Capital', subsection: 'Materials',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.32',
  },
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.33',
  },
  {
  ...
  // ─── Natural Capital — Water (GRI 303) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.34',
  },
  {
    griCode: '303-3 (2018)', section: 'Natural Capital', subsection: 'Water',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.35',
  },
  {
    griCode: '303-4 (2018)', section: 'Natural Capital', subsection: 'Water',
  ...
  },
  {
    ...
    targetFy2026: 2300,
    sourceReport: 'Demo Co FY2025 SPD — p.36',
  },
  {
  ...
  },
  {
    ...
    values: { 2022: 0, 2023: 0, 2024: 0, 2025: 0 },
    sourceReport: 'Demo Co FY2025 SPD — p.38',
  },
  ...
  // ─── Natural Capital — Operational Eco-Efficiency ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.39',
  },
  ...
  // ═══════════════════════════════════════════
  // JV Parallel Scope (Logistics JV + Biochem JV + Polymers JV)
  // ═══════════════════════════════════════════
  ...
  // ─── JV Workforce (GRI 2-7) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.41',
  },
  {
    griCode: '2-8 (2021)', section: 'Human Capital', subsection: 'Workforce',
  ...
  // ─── JV Energy (GRI 302) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.53',
  },
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.54',
  },
  {
    griCode: '305-7 (2016)', section: 'Natural Capital', subsection: 'Air Emissions',
  ...
  },
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.55',
  },
  {
    griCode: '303-5 (2018)', section: 'Natural Capital', subsection: 'Water',
  ...
  // ─── JV Waste (GRI 306) ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.56',
  },
  {
    griCode: '306-3 (2020)', section: 'Natural Capital', subsection: 'Waste',
  ...
  // ─── JV Operational ───
  {
    ...
    sourceReport: 'Demo Co FY2025 SPD — p.59',
    footnoteRefs: ['Recalculated in 2025 due to Asahi JV cessation'],
  },
]
...
export const DEMO_HEADLINES = {
  reportingYear: 2025,
  reportingScope: 'Demo Co + 11 subsidiaries — >75% of total revenue',
  headOffice: '1 Demo Plaza, Industrial District, City Center',
  ...
  assurance: {
    provider: 'Independent Assurance Ltd',
    ...
    scope: [
      'Unit A (UT, OLE1) Olefin business units',
      'Unit B Jetty and buffer tank farm',
      'Unit C Aromatic tank farm',
      'Unit D Aromatics plant',
      'Unit E Phenol plant',
      'Polyol sub',
      'Maintenance sub',
      'PET Resin sub',
...
export const getByCapital = (section: string, scope: ReportingScope = 'group') =>
  DEMO_HISTORICAL_VALUES.filter(v => v.section === section && v.reportingScope === scope)
