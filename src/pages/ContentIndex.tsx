...
import { CheckCircle2, Circle, AlertTriangle, Printer, Download, Search, Filter } from 'lucide-react'
    ...
    <div className="page-container animate-fade-in">
      ...
      <PageHeader
        breadcrumbs={[
          ...
          { label: 'Disclosures library' },
        ]}
        eyebrow="Disclosures Library"
        title="Disclosures Library"
        description="Auto-generated from your assignments. Every GRI disclosure, its status, the section it lives in, and the material topic it answers. This is the table that opens every GRI-compliant report."
        actions={
